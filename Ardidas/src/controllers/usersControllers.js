...
const usersController = {
    ...
    UsersDashboard: (req, res) => {
        db.User.findAll({
            ...
            .then((users) => {
                ...
                console.log("dashboard users", users);
                res.render("users/usersDashboard", {title: "Dashboard",users: users,usuarioLogeado: req.session.usuarioLogin,
                });
            })
            .catch((err) => console.log(err));
    },
    ...
    createUserPrivileges: (req, res) => {
        ...
        if (!errores.isEmpty()) { // creacion de usuarios desde el dashboard.
            console.log("Ingrese en errores");
    ...
    usersEdit: (req, res) => {
        ...
        db.User.findByPk(req.params.id)  // vista de edicion de usuario desde el dashboard.
            .then((user) => {res.render("users/usersEdit", {title: "Editar Usuario",user,usuarioLogeado: req.session.usuarioLogin,
                });
            })
            .catch((err) => console.log(err));
    },
    ...
    usersUpdate: (req, res) => {
        ...
        db.User.findByPk(req.params.id)
            .then((user) => {
                if (!errores.isEmpty()) {console.log("Ingrese en errores");
                    ...
                    db.User.update({
                        ...
                        .then(() => {res.redirect(`/users/update/${id}`);
                        })
                        .catch((err) => console.log(err));
                }
            })
