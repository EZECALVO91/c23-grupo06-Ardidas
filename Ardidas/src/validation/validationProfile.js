...
module.exports = [
    ...
    //Input: Localidad
    body('locality').isLength({min:4 , max:30}).withMessage("*Minimo de 5 letrasy un Maximo de 30"),

    //Input:Sobremi
    body('aboutMe').isLength({min:5, max:500}).withMessage("*Minimo 5 letras y un Maximo de 500.").bail(),
